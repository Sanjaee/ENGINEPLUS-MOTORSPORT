                            ...
                            <table width="100%" style="margin-bottom: 3px; border-radius: 4px; border: thin dashed #cccccc;">
                                <tr style="background-color: rgba(242, 242, 242, 0.74);">
                                    <th style="width: 100px; text-align: center;">
                                        <span style="font-weight: bold; font-size: 12;">Ordering Sparepart</span>
                                    </th>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table width="100%" style="padding-left: 10px; margin-top: 5px; border-radius: 4px; border: thin dashed #cccccc;">
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <span style="color: #000000; font-weight: normal;"><?php echo $cell->kodesupplier ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 95px;">
                                ...
                                <tr>
                                    <td style="width: 95px;">
                                        <span style="font-weight: bold">Keterangan Order</span>
                                    </td>
