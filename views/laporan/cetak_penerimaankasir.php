    ...
    <div class="content">
        <table width="100%" style="padding-top: 5px; padding-left: 10px">
            <tr>
                <?php foreach ($penerimaan as $cell) : ?>
                    <td width="75%">
                        <span style="font-weight: bold; font-size: 12;">Bukti Terima Uang No. <?php echo $cell->nomor ?></span><br><br>
                ...
                <tr>
                    <td width="50%" style="vertical-align: top;">
                        <table width="100%" style="padding-left: 10px; padding-top: 10px; padding-bottom: 10px;margin-top: 5px; border-radius: 4px; border: thin dashed #cccccc;">
                            ...
                            <tr>
                                <td style="width: 150px;">
                                    <span style="font-weight: normal; font-size: 8;">Jenis Penerimaan</span>
                                </td>
                                <?php foreach ($penerimaan as $cell) : ?>
                                    <td colspan="2">
                        ...
                        <table width="100%" style="border-radius: 4px; border: thin dashed #cccccc;">
                            <tr style="background-color: rgba(242, 242, 242, 0.74);">
                                ...
                                <th style="text-align: center;">
                                    <span style="font-weight: bold">No Dokumen</span>
                                </th>
                            ...
                            foreach ($detail as $cell) : ?>
                                <?php if ($cell->accountalokasi != '') { ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <span style="font-weight: normal"><?php echo $cell->namapenghapusan ?></span>
                                        </td>
                                        <td style="text-align: center;">
