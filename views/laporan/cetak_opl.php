    ...
    <div class="content">
        <table width="100%" style="padding-top: 5px; padding-left: 10px">
            <tr>
                <?php foreach ($opl as $cell) : ?>
                    <td width="75%">
                        <span style="font-weight: bold; font-size: 12;">OPL No.&nbsp;<?php echo $cell->nomor ?></span>
                    </td>
                    ...
                    <tr>
                        <td width="60%" style="vertical-align: top;">
                            <table width="100%" style="padding-left: 10px; margin-top: 5px; border-radius: 4px; border: thin dashed #cccccc;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <span style="color: #000000; font-weight: normal;"><?php echo $cell->nowo ?></span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td width="40%" style="vertical-align: top;">
                            <table width="100%" style="margin-top: 5px; border-radius: 4px; border: thin dashed #cccccc; padding-bottom: 0px; padding-left: 30px;">
                                <tr>
                                    <td>
                                        <span style="font-weight: normal">Supplier</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <span style="color: #000000; font-weight: bold;"><?php echo $cell->namasupplier ?></span>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <table width="100%" style="margin-bottom: 3px; border-radius: 4px; border: thin dashed #cccccc;">
                            <tr style="background-color: rgba(242, 242, 242, 0.74);">
                                <th style="width: 100px; text-align: center;">
                                    <span style="font-weight: bold">Order Pekerjaan Luar</span>
                                </th>
                            </tr>
                        </table>
                    </td>
                            ...
                            foreach ($opl as $cell) : ?>
                                <tr>
                                    <td style="text-align: center;">
                                        <span style="font-weight: normal"><?php echo rupiah($cell->dppbeli) ?></span>
                                    </td>
                                    <td style="text-align: center;">
                                        <span style="font-weight: normal"><?php echo rupiah($cell->ppnbeli) ?></span>
                                    </td>
                                    <td style="text-align: center;">
