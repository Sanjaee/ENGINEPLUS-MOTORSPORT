            ...
            <tr>
                <td width="50%" style="vertical-align: top;">
                    <table width="100%" style="text-align: center; padding: 5px; ">
                        ...
                        <tr>
                            <td>
                                <span style="font-size: 10; font-weight: bold">LAPORAN FAKTUR HARIAN DAN PENERIMAAN</span>
                            </td>
                        </tr>
        ...
        <table width="100%" style="margin-top: 5px; border: thin solid grey; border-radius: 4px;">
            <tbody>
                <tr style="background-color: rgba(242, 242, 242, 0.74); ">
                    ...
                    <th style="text-align: center; ">
                        <span style="font-weight: bold">Nomor Referensi</span>
                    </th>
                    <th style="text-align: center; ">
                    ...
                    <th style="text-align: center; ">
                        <span style="font-weight: bold">Market Place</span>
                    </th>
                    <th style="text-align: center; ">
                ...
                foreach ($report_faktur as $row) : ?>
                    ...
                    <tr style="line-height: 0.5 cm; ">
                        ...
                        <td style="text-align: right; border-bottom: thin solid grey;">
                            <span style="font-weight: normal"><?php echo rupiah($row->tunai) ?></span>
                        </td>

                        <td style="text-align: right; border-bottom: thin solid grey;">
                            <span style="font-weight: normal"><?php echo rupiah($row->bank) ?></span>
                        </td>

                        <td style="text-align: right; border-bottom: thin solid grey;">
                            <span style="font-weight: normal"><?php echo rupiah($row->debit) ?></span>
                        </td>

                        <td style="text-align: right; border-bottom: thin solid grey;">
                            <span style="font-weight: normal"><?php echo rupiah($row->kredit) ?></span>
                        </td>

                        <td style="text-align: right; border-bottom: thin solid grey;">
                            <span style="font-weight: normal; "><?php echo rupiah($row->marketplace) ?></span>
                        </td>
                        ...
                        <td style="text-align: right; border-bottom: thin solid grey;">
                            <span style="font-weight: normal; "><?php echo rupiah($row->sisapiutang) ?></span>
                        </td>
        ...
        <table width="100%" style="margin-top: 10px;">
            ...
            <tbody style="border: thin solid grey; border-radius: 4px;">
                <tr style="background-color: rgba(242, 242, 242, 0.74); ">
                    ...
                    <th style="text-align: center; ">
                        <span style="font-weight: bold">Total Tunai</span>
                    </th>
                    <th style="text-align: center; ">
                        <span style="font-weight: bold">Total Bank</span>
                    </th>
                    <th style="text-align: center; ">
                        <span style="font-weight: bold">Total Debit</span>
                    </th>
                    <th style="text-align: center; ">
                        <span style="font-weight: bold">Total Kredit</span>
                    </th>
                    <th style="text-align: center; ">
                        <span style="font-weight: bold">Total Market Place</span>
                    </th>
                ...
                foreach ($totalsum as $row) : ?>
                    ...
                    <tr style="line-height: 0.5 cm; ">
                        <td style="text-align: center; border-bottom: thin solid grey;">
                            <span style="font-weight: normal"><?php echo rupiah($row->totaltunai) ?></span>
                        </td>

                        <td style="text-align: center; border-bottom: thin solid grey;">
                            <span style="font-weight: normal"><?php echo rupiah($row->totalbank) ?></span>
                        </td>

                        <td style="text-align: center; border-bottom: thin solid grey;">
                            <span style="font-weight: normal"><?php echo rupiah($row->totaldebit) ?></span>
                        </td>

                        <td style="text-align: center; border-bottom: thin solid grey;">
                            <span style="font-weight: normal"><?php echo rupiah($row->totalkredit) ?></span>
                        </td>

                        <td style="text-align: center; border-bottom: thin solid grey;">
                            <span style="font-weight: normal; "><?php echo rupiah($row->totalmarketplace) ?></span>
                        </td>
