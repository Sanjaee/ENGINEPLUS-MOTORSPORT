    ...
    <div class="content">
            ...
            <tr>
                <td width="50%" style="vertical-align: top;">
                    <table width="100%" style="text-align: center; padding: 3px; ">
                        ...
                        <tr>
                            <td>
                                <span style="font-size: 10; font-weight: bold">DATA HISTORY PART</span>
                            </td>
                        </tr>
        ...
        <table width="100%" style="margin-top: 5px; ">
            ...
            <tbody style = "border: thin solid grey; border-radius: 4px;">
                ...
                <?php $no = 1; foreach($history_sparepart as $row):?>
                ...
                <tr style="line-height: 0.25 cm; ">
                    ...
                    <td style="text-align: center; border-bottom: thin solid grey;">
                        <span style="font-weight: normal"><?php echo $row->nomor_referensi ?></span>
                    </td>
        ...
        <table width="100%" style="margin-top: 5px;">
            ...
            <td width="20%" style="vertical-align: top;">
                <table width="100%" style="font-size: 10; padding-left: 5px; margin-top: 5px; border-radius: 4px; border: thin solid grey;">
                    <tr>
                        <td>
                            <span style="font-weight: bold;">Total Stock Part :</span>
                        </td>
                        <?php foreach($totalsum as $cell)?>
                        <td>
                            <span style="color: #000000; font-weight: bold;"><?php echo $cell->totalqty ?> Pcs</span>
                        </td>
                    </tr>
                </table>
            </td>
