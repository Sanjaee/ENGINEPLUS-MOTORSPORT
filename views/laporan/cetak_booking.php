    ...
    <div class="content">
        <table width="100%" style="padding-top: 5px; padding-left: 10px">
            <tr>
                <?php foreach ($booking as $cell) : ?>
                    <td width="75%">
                        <span style="font-weight: bold; font-size: 12;">Booking Service No.&nbsp;<?php echo $cell->nomor ?></span>
                    </td>

                    <td width="25%">
                        <span style="font-weight: bold">Tanggal</span>
                        &nbsp;&nbsp;&nbsp;
                        <span style="color: #000000; font-weight: bold;"><?php echo $cell->tanggalbooking ?></span>
                    </td>
                <?php endforeach ?>
            </tr>
        </table>
        ...
        <?php foreach ($booking as $cell) : ?>
            <div>
                <table width="100%" style="margin-top: -6px; vertical-align: top;">
                    <tr>
                        <td width="60%" style="vertical-align: top;">
                            <table width="100%" style="padding-left: 10px; margin-top: 5px; border-radius: 4px; border: thin dashed #cccccc;">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <span style="color: #000000; font-weight: normal;"><?php echo $cell->pic ?> / <?php echo $cell->nohppic ?></span>
                                    </td>
                        ...
                        <table width="100%" style="margin-bottom: 3px; border-radius: 4px; border: thin dashed #cccccc;">
                            <tr style="background-color: rgba(242, 242, 242, 0.74);">
                                <th style="width: 100px; text-align: center;">
                                    <span style="font-weight: bold">Estimasi Part dan Jasa</span>
                                </th>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table width="100%" style="border-radius: 4px; border: thin dashed #cccccc;">
                            <tr style="background-color: rgba(242, 242, 242, 0.74);">
                                ...
                                <th style="text-align: center;">
                                    <span style="font-weight: bold">Kode Pekerjaan/Part</span>
                                </th>
                                <th style="width: 200px; text-align: center;">
                                    <span style="font-weight: bold">Nama Pekerjaan/Part</span>
                                </th>
                                <th style="text-align: center;">
            ...
            <tr>
                ...
                <td style="vertical-align: top; text-align: center;">
                    <table width="100%" style="border-radius: 4px; border: thin dashed #cccccc;">
                        <tr style="background-color: rgba(242, 242, 242, 0.74);">
                            <th style="width: 100px; text-align: center;">
                                <span style="font-weight: bold">Service Coordinator</span>
                            </th>
                        </tr>
