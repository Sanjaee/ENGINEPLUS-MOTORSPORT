                ...
                <tr>
                    ...
                    <td width="50%" style="vertical-align: top;">
                        ...
                        <table width="100%" style="text-align: center; padding: 5px; margin-top: 5px; border-radius: 4px; border: thin solid grey;">
                            <tr>
                                <td>
                                    <span style="font-size: 10; font-weight: bold">LAPORAN PENERIMAAN UANG</span>
                                </td>
                ...
                <tbody style = "border: thin solid grey; border-radius: 4px;">
                    <tr style="background-color: rgba(242, 242, 242, 0.74);">
                        ...
                        <th style="width: 200px; text-align: center; ">
                            <span style="font-weight: bold">Jenis Penerimaan</span>
                        </th>
                        <th style="text-align: center; ">
                        ...
                        <th style="text-align: center; ">
                            <span style="font-weight: bold">Tanggal Penerimaan</span>
                        </th>
                        <th style="text-align: center; ">
                    ...
                    <?php $no = 1; foreach($report_penerimaan as $row):?>
                    ...
                    <tr style="line-height: 0.5 cm; ">
                        ...
                        <td style="text-align: center; border-bottom: thin solid grey;">
                            <span style="font-weight: normal"><?php echo $row->tglpenerimaan ?></span>
                        </td>
                        <td style="text-align: center; border-bottom: thin solid grey;">
            ...
            <table width="100%" style="margin-top: 5px;">
                ...
                <td width="30%" style="vertical-align: top;">
                    <table width="100%" style="font-size: 10; padding: 10px; margin-top: 5px; border-radius: 4px; border: thin solid grey;">
                        <tr>
                            <td>
                                <span style="font-weight: bold">Total Penerimaan :</span>
                            </td>

                            <?php foreach($totalsum as $cell):?>
                            
                            <td>
                                <span style="color: #000000; font-weight: bold;"><?php echo rupiah($cell->totalpenerimaan) ?>,-</span>
                            </td>
                            <!-- <?php endforeach ?> -->
                        </tr>
                    </table>
