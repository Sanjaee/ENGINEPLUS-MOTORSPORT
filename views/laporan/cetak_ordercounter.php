    ...
    <div class="content">
        <table width="100%" style="padding-top: 5px; padding-left: 10px">
            <tr>
                <?php foreach ($counter as $cell) : ?>
                    <td width="75%">
                        <span style="font-weight: bold; font-size: 12;">No. Order &nbsp;<?php echo $cell->nomor ?></span>
                    </td>
                    ...
                    <tr>
                        <td width="60%" style="vertical-align: top;">
                            <table width="100%" style="padding-left: 10px; margin-top: 5px; border-radius: 4px; border: thin dashed #cccccc;">
                                ...
                                <tr>
                                    <td style="width: 70px;">
                                        <span style="font-weight: bold">No Telp/HP</span>
                                    </td>
        ...
        <div>
            ...
            <table width="100%" style="margin-bottom: 3px; border-radius: 4px; border: thin dashed #cccccc;">
                <tr style="background-color: rgba(242, 242, 242, 0.74);">
                    <th style="width: 100px; text-align: center;">
                        <span style="font-weight: bold">Ordering Part Counter</span>
                    </th>
                </tr>
            </table>
            <!-- </td>
            ...
            <table width="100%" style="border-radius: 4px; border: thin dashed #cccccc;">
                <tr style="background-color: rgba(242, 242, 242, 0.74);">
                    ...
                    <th style="text-align: right;">
                        <span style="font-weight: bold">Disc RP</span>
                    </th>
                    <th style="text-align: right;">
                ...
                foreach ($counterdetail as $row) : ?>
                    ...
                    <tr style="line-height: 1em;">
                        ...
                        <td style="width: 180px; text-align: left; border-bottom: thin dashed #cccccc;">
                        ...
                        <table width="100%" style="margin-bottom: 3px; border-radius: 4px; border: thin dashed #cccccc;">
                            ...
                            foreach ($counter as $cell) : ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <span style="font-weight: normal"><?php echo rupiah($cell->ongkir) ?></span>
                                    </td>
                                    <td style="text-align: center;">
