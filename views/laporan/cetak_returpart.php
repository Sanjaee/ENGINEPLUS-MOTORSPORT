    ...
    <div class="content">
        <table width="100%" style="padding-top: 3px; padding-left: 10px; border-bottom: thin dashed #cccccc;">
            <tr>
                <?php foreach ($penerimaan as $cell) : ?>
                    <td width="75%">
                        <span style="font-weight: bold; font-size: 12;">No. Retur &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $cell->nomor ?></span>
                    </td>
            ...
            <tr>
                <?php foreach ($penerimaan as $cell) : ?>
                    <td width="75%">
                        <span style="font-weight: bold; font-size: 10;">No. Penerimaan &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $cell->nomorpenerimaan ?></span>
                    </td>
                <?php endforeach ?>
            </tr>
        ...
        <?php foreach ($penerimaan as $cell) : ?>
            <div>
                <table width="100%" style="margin-top: -3px; vertical-align: top;">
                    <tr>
                        <td width="60%" style="vertical-align: top;">
                        ...
                        <table width="100%" style="margin-bottom: 3px; border-radius: 4px; border: thin dashed #cccccc;">
                            <tr style="background-color: rgba(242, 242, 242, 0.74);">
                                <th style="width: 100px; text-align: center;">
                                    <span style="font-weight: bold">Retur Penerimaan Sparepart</span>
                                </th>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td width="100%" style="vertical-align: top;">
                        <table width="100%" style="border-radius: 4px; border: thin dashed #cccccc;">
                            <tr style="background-color: rgba(242, 242, 242, 0.74);">
                                ...
                                <th style="text-align: center;">
                                    <span style="font-weight: bold">Discount per item</span>
                                </th>
                                <th style="text-align: center;">
                                    <span style="font-weight: bold">Total</span>
                                </th>
                                <th style="text-align: center;">
                                    <span style="font-weight: bold">Biaya Penalti</span>
                                </th>
                            </tr>
                            ...
                            foreach ($detailpenerimaan as $row) : ?>
                                ...
                                <tr style="line-height: 1cm;">
                                    ...
                                    <td style="text-align: right; border-bottom: thin dashed #cccccc;">
                                        <span style="font-weight: normal"><?php echo rupiah($row->biayapenalti) ?></span>
                                    </td>
                                </tr>
                ...
                <tr>
                    <td width="100%" style="vertical-align: top;">
                        <table width="100%" style="margin-bottom: 3px; border-radius: 4px; border: thin dashed #cccccc;">
                            <tr style="background-color: rgba(242, 242, 242, 0.74);">
                                <th style="width: 100px; text-align: center;">
                                    <span style="font-weight: bold">Total Penalti</span>
                                </th>
                                <th style="width: 100px; text-align: center;">
                            ...
                            foreach ($penerimaan as $cell) : ?>
                                <tr>
                                    <td style="text-align: center;">
                                        <span style="font-weight: normal"><?php echo rupiah($cell->totalbiayapenalti) ?></span>
                                    </td>
                                    <td style="text-align: center;">
