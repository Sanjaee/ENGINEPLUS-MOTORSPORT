            ...
            <tr>
                <td width="50%" style="vertical-align: top;">
                    <table width="100%" style="text-align: center; padding: 3px; ">
                        ...
                        <tr>
                            <td>
                                <span style="font-size: 10; font-weight: bold">LAPORAN TOOLS CONTROL AR GENERAL REPAIR</span>
                            </td>
                        </tr>
        ...
        <table width="100%" style="margin-top: 5px; border: thin solid grey; border-radius: 4px;">
            <tbody>
                <tr style="background-color: rgba(242, 242, 242, 0.74); ">
                    ...
                    <th style="text-align: center; ">
                        <span style="font-weight: bold">Umur AR</span>
                    </th>
                    <th style="text-align: center; ">
                ...
                <?php $no = 1;
                $totalsisaar = 0;
                foreach ($workshopardetail as $row) : ?>
                    <?php $sisaar = intval($row->nilaifaktur) - (intval($row->nilaiuangmuka) + intval($row->nilaipenerimaan)) ?>
