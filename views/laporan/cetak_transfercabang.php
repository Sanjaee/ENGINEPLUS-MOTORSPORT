                ...
                <tr>
                    <td width="60%" style="vertical-align: bottom;">
                        ...
                        <table width="100%" style="padding: 10px; margin-top: 5px;">
                            ...
                            <tr>
                                <td colspan = "4">
                                    <span style= "font-weight: bold; font-size: 12;" >Cabang  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</span>
                                </td>
                                <td colspan = "4">
                                    <span style="color: #000000; font-weight: bold; font-size: 14;"><?php echo $cell->kode_cabangorder ?></span>
                                </td>
                            </tr>

                            <tr>
                                <td colspan = "4">
                                    <span style= "font-weight: bold; font-size: 12;" >No Request  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</span>
                                </td>
                                <td colspan = "4">
                                    <span style="color: #000000; font-weight: bold; font-size: 14;"><?php echo $cell->nomororder ?></span>
                                </td>
                            </tr>
                        ...
                        <table width="100%" style="margin-bottom: 3px; border-radius: 4px; border: thin dashed #cccccc;">
                            <tr style="background-color: rgba(242, 242, 242, 0.74);">
                                <th style="width: 100px; text-align: center;">
                                    <span style="font-weight: bold">Transfer Sparepart Ke Cabang</span>
                                </th>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td width="100%" style="vertical-align: top;">
                        <table width="100%" style="border-radius: 4px; border: thin dashed #cccccc;">
                            ...
                            <?php $no = 1; foreach($transferdetail as $row):?>
