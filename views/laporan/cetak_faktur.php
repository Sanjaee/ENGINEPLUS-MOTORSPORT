                ...
                <td width="50%" style="vertical-align: top; ">
                    <table width="100%" style="font-size: 10; border-radius: 4px; border: thin dashed #cccccc;">
                        ...
                        <?php }else if ($cell->kode_cabang == 'EPL') { ?>
                            <td colspan="3">
                                <br>
                                <span style="font-weight: bold; font-size: 11px;">BCA PT Karya Berkat Semesta 6460-460008</span>
                            </td>
                        <?php } else if ($cell->kode_cabang == 'KSS') { ?>
                            <td colspan="3">
                                <br>
                        ...
                        <?php } else if ($cell->kode_cabang == 'CAD') { ?>
                            <td colspan="3">
                                <br>
                                <span style="font-weight: bold; font-size: 11px;">Bank BCA 428-313131-1 a/n Oey Rendi</span>
                            </td>
                        <?php } else if ($cell->kode_cabang == 'WKS') { ?>
                            <td colspan="3">
                                <br>
                                <span style="font-weight: bold; font-size: 11px;">Bank BCA 8770135525 a/n KLARA ASTRID</span>
                            </td>
                        <?php } else { ?>
                            <td colspan="3">
                                <br>
