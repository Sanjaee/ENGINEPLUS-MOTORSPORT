...
<body>
    ...
    <div class="nav-bar">
        <table width="100%" style="padding-bottom: 10px; border-radius: 4px; border-bottom: thin dashed #cccccc;">
            <tr>
                <?php foreach ($penghapusan as $cell) : ?>
    ...
    <div class="content">
        <table width="100%" style="padding-top: 5px; padding-left: 10px">
            <tr>
                <?php foreach ($penghapusan as $cell) : ?>
                    <td width="75%">
                        <span style="font-weight: bold; font-size: 12;">Bukti Penghapusan Piutang No.</span><br>
                        ...
                        <table width="100%" style="padding-left: 10px; padding-top: 10px; padding-bottom: 10px;margin-top: 5px; border-radius: 4px; border: thin dashed #cccccc;">
                            <tr>
                                <td style="width: 150px;">
                                    <span style="font-size: 10; font-weight: normal">Keterangan :</span>
                                </td>

                                <?php foreach ($penghapusan as $cell) : ?>
                                    <td colspan="3">
                                        <span style="color: #000000; font-size: 12; font-weight: bold;"><?php echo $cell->keterangan ?></span>
                                    </td>
                            ...
                            <tr>
                                <td style="width: 150px;">
                                    <span style="font-size: 8; font-weight: normal">Nomor Account Penghapusan</span>
                                </td>

                                <td colspan="2">
                                    <span style="color: #000000; font-size: 8; font-weight: bold;"><?php echo ($cell->nomoraccount) ?> - <?php echo ($cell->nama) ?> </span>
                                </td>
                                <!-- <?php endforeach ?> -->
                            ...
                            <tr>
                                <td style="width: 150px;">
                                    <span style="font-weight: normal; font-size: 8;">Jenis Penghapusan</span>
                                </td>

                                <td colspan="2">
                                    <span style="color: #000000; font-size: 8; font-weight: bold;">
                                        <?php if ($cell->jenistransaksi == "51") {
                                            echo "FAKTUR GENERAL REPAIR";
                                        } else if ($cell->jenistransaksi == "52") {
                                            echo "FAKTUR PART COUNTER";
                                        }
                                        ?>
                                    </span>
                                </td>
                    ...
                    <td width="100%" style="vertical-align: top;">
                        <table width="100%" style="margin-bottom: 3px; border-radius: 4px; border: thin dashed #cccccc;">
                            <tr style="background-color: rgba(242, 242, 242, 0.74);">
                                ...
                                <th style="width: 100px; text-align: center;">
                                    <span style="font-weight: bold">Workshop Manager</span>
                                </th>
                                <th style="width: 100px; text-align: center;">
                                    <span style="font-weight: bold">Keuangan</span>
                                </th>
                                <th style="width: 100px; text-align: center;">
                                    <span style="font-weight: bold">Pimpinan</span>
                                </th>
                            </tr>
