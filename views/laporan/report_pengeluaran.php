        ...
        <div class="content">
                ...
                <tr>
                    ...
                    <td width="50%" style="vertical-align: top;">
                        ...
                        <table width="100%" style="text-align: center; padding: 5px; margin-top: 5px; border-radius: 4px; border: thin solid grey;">
                            <tr>
                                <td>
                                    <span style="font-size: 10; font-weight: bold">LAPORAN PENGELUARAN UANG</span>
                                </td>
                            </tr>
                ...
                <tbody style = "border: thin solid grey; border-radius: 4px;">
                    <tr style="background-color: rgba(242, 242, 242, 0.74);">
                        ...
                        <th style="text-align: center; ">
                            <span style="font-weight: bold">No Pengeluaran</span>
                        </th>
                        <th style="width: 200px; text-align: center; ">
                            <span style="font-weight: bold">Jenis Pengeluaran</span>
                        </th>
                        <th style="text-align: center; ">
                    ...
                    <?php $no = 1; foreach($report_pengeluaran as $row):?>
                    ...
                    <tr style="line-height: 0.5 cm; ">
                        ...
                        <td style="text-align: center; border-bottom: thin solid grey;">
                            <span style="font-weight: normal"><?php echo $row->nopembayaran ?></span>
                        </td>

                        <td style="width: 200px; text-align: center; border-bottom: thin solid grey;">
                        ...
                        <td style="text-align: center; border-bottom: thin solid grey;">
                            <span style="font-weight: normal"><?php echo $row->noaccount ?></span>
                        </td>
                        ...
                        <td style="text-align: center; border-bottom: thin solid grey;">
                            <span style="font-weight: normal"><?php echo $row->tglpengeluaran ?></span>
                        </td>
                        <td style="text-align: center; border-bottom: thin solid grey;">
            ...
            <table width="100%" style="margin-top: 5px;">
                ...
                <td width="30%" style="vertical-align: top;">
                    <table width="100%" style="font-size: 10; padding: 5px; margin-top: 5px; border-radius: 4px; border: thin solid grey;">
                        <tr>
                            <td>
                                <span style="font-weight: normal">Total pengeluaran :</span>
                            </td>

                            <?php foreach($totalsum as $cell):?>
                            
                            <td>
                                <span style="color: #000000; font-weight: bold;"><?php echo rupiah($cell->totalpengeluaran) ?>,-</span>
                            </td>
                            <!-- <?php endforeach ?> -->
                        </tr>
                    </table>
