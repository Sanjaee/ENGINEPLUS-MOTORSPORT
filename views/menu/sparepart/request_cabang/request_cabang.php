        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" name="nomor" id="nomor" maxlength="50" value="<?php echo ("RC" . substr(date("Y"), 2, 2) . date("m") . "00000"); ?>" readonly required />
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="kodecabang">Cabang</label>
                            <div class="col-sm-2 form-group">
                                <input class="form-control" type="text" name="kodecabangtujuan" id="kodecabangtujuan" maxlength="50" placeholder="Kode" readonly required />
                            </div>
                            <div class="col-sm-5 form-group">
                                <input class="form-control" type="text" name="namacabangtujuan" id="namacabangtujuan" maxlength="50" placeholder="Nama" readonly required />
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-sm-1 col-form-label" for="qty">Qty</label>
                            <div class="col-sm-3 form-group">
