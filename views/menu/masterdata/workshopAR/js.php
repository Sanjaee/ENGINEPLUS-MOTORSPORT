<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var tipe = data[i].tipe.trim();
                        var estimasi_part = data[i].totalpart.trim();
                        var estimasi_jasa = data[i].totaljasa.trim();
                        var estimasi_opl = data[i].totalopl.trim();
                        var total_estimasi = data[i].nilaispk.trim();
                        var nilaiuangmuka = data[i].nilaiuangmuka.trim();
                        var sisauangmuka = data[i].sisaum.trim();
                        var umurwo = data[i].umur.trim();
                        var statuskendaraan = data[i].statuskendaraan.trim();
                        var statuspekerjaanmobil = data[i].statuspekerjaanmobil.trim();
                        var jeniscustomer = data[i].jeniscustomer.trim();
                        var statussum = data[i].statussum.trim();

                        insertdataworkshopAR_WOOpen(nospk, customer, tipe, estimasi_part, estimasi_jasa, estimasi_opl, total_estimasi, nilaiuangmuka, sisauangmuka, statuskendaraan, statuspekerjaanmobil, jeniscustomer, statussum, umurwo);
        ...
        function insertdataworkshopAR_WOOpen(nospk, customer, tipe, estimasi_part, estimasi_jasa, estimasi_opl, total_estimasi, nilaiuangmuka, sisauangmuka, statuskendaraan, statuspekerjaanmobil, jeniscustomer, statussum, umurwo) {
            var row = "";
            ...
            row =
                ...
                '<td>' + customer + '</td>' +
                '<td>' + tipe + '</td>' +
                '<td style="text-align:right;">' + formatRupiah(estimasi_part.toString(), '') + '</td>' +
                '<td style="text-align:right;">' + formatRupiah(estimasi_jasa.toString(), '') + '</td>' +
                '<td style="text-align:right;">' + formatRupiah(estimasi_opl.toString(), '') + '</td>' +
                ...
                '<td style="text-align:left;">' + statuskendaraan + '</td>' +
                '<td style="text-align:left;">' + statuspekerjaanmobil + '</td>' +
                '<td style="text-align:left;">' + jeniscustomer + '</td>' +
