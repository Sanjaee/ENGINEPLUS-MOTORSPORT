<script type="text/javascript">
	$(document).ready(function() {
		...
		document.getElementById("save").addEventListener("click", function(event) {
			...
			if (CekValidasi() == true) {
				$.ajax({
					url: "<?php echo base_url('masterdata/project_manager/save'); ?>",
					method: "POST",
					dataType: "json",
					async: true,
					data: {
		...
		$(document).on('click', ".searchok", function() {
			...
			$.ajax({
				url: "<?php echo base_url('masterdata/project_manager/find'); ?>",
				method: "POST",
				dataType: "json",
				async: true,
				data: {
		...
		document.getElementById("update").addEventListener("click", function(event) {
			...
			if (CekValidasi() == true) {
				$.ajax({
					url: "<?php echo base_url('masterdata/project_manager/update'); ?>",
					method: "POST",
					dataType: "json",
					async: true,
					data: {
