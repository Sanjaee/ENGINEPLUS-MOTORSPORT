            ...
            <div class="row text-left pad-top">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="nama">Harga FRT &emsp;&nbsp; :</label>
                        <input class="form-control" type="text" name="frt" id="frt" maxlength="50" placeholder="FRT" required/>
                    </div>
            ...
            <div id="tablesearchtampil">
                <center>
                    ...
                    <div class="popupsearch">  
                        <div class="pre-scrollable">
                            <h3 align="center">Pencarian Product</h3>  
