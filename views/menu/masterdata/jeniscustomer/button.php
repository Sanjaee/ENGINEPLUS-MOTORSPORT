<script type="text/javascript">
	$(document).ready(function() {
		...
		document.getElementById("save").addEventListener("click", function(event) {
			...
			if (CekValidasi() == true) {
				$.ajax({
					url: "<?php echo base_url('masterdata/jeniscustomer/save'); ?>",
					method: "POST",
					dataType: "json",
					async: true,
					data: {
		...
		$(document).on('click', ".searchok", function() {
			...
			$.ajax({
				url: "<?php echo base_url('masterdata/jeniscustomer/find'); ?>",
				method: "POST",
				dataType: "json",
				async: true,
				data: {
		...
		document.getElementById("update").addEventListener("click", function(event) {
			...
			if (CekValidasi() == true) {
				$.ajax({
					url: "<?php echo base_url('masterdata/jeniscustomer/update'); ?>",
					method: "POST",
					dataType: "json",
					async: true,
					data: {
