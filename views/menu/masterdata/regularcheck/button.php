...
// -- SAVE --
        document.getElementById("save").addEventListener("click", function(event) {
            ...
            var aktif= $("input[name='aktif']:checked").val();
                    ...
                    if(CekValidasi() == true){
                        $.ajax({  
                            url:"<?php echo base_url('masterdata/regularcheck/save'); ?>",  
                            method:"POST", 
                            dataType: "json",
                            async : true,
                            data:{
...
// -- FIND --
        ...
        document.getElementById("closesearch").addEventListener("click", function(event) {
            ...
            $(document).on('click', ".searchok", function() {
                ...
                $.ajax({  
                url:"<?php echo base_url('masterdata/regularcheck/find'); ?>",  
                method:"POST", 
                dataType: "json",
                async : true,
                data:{kode:kode},  
...
// -- UPDATE --
        document.getElementById("update").addEventListener("click", function(event) {
            ...
            if(CekValidasi() == true){
                $.ajax({    
                    url:"<?php echo base_url('masterdata/regularcheck/update'); ?>",  
                    method:"POST", 
                    dataType: "json",
                    async : true,
                    data:{
