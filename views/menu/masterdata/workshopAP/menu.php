<div class="modal-header" style="padding: 5px;">
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-5">
                <h2>
                    ...
                    <span class="text-uppercase">Tools Control AP</span>
                </h2>
            </div>
            <div class="col-md-7">
        ...
        <span style="color: red; font-size: 10; font-weight: normal">Note : OUTSTANDING PO TIDAK PERLU ISI RANGE TANGGAL.</span>
    </div>
</div>
            ...
            <div class="card-body">
                ...
                <div>
                    <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7 form-group">
                                    <select name="jenisfaktur" class="form-control" id="jenisfaktur">
                                        ...
                                        <option value="0">ORDER PEKERJAAN LUAR LUNAS</option>
                                        <option value="1">ORDER PEKERJAAN LUAR BELUM LUNAS</option>
                                        <option value="2">PEMBELIAN PART LUNAS</option>
                                        <option value="3">PEMBELIAN PART BELUM LUNAS</option>
                                        <option value="4">OUTSTANDING PO</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="pencairan">Nama Supplier</label>
                                <div class="col-md-7 form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label" for="pencairan">Total Sisa AP</label>
                                            <div class="col-md-7 form-group">
                                                <input class="form-control" style="text-align:right;" type="text" name="totalar" id="totalar" readonly required>
                                            </div>
                                        </div>
                                    </div>
                                    <table class="table table-bordered table-striped" id="detailworkshopap">
                                        <thead id="headerworkshopAP">
                                        </thead>
                                        <tbody id="datadetailworkshopap"></tbody>
                                    </table>
                                </div>
                                <!-- </div> -->
                            </div>
