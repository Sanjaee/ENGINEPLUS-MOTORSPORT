            ...
            <div class="row text-left pad-top">
            	<div class="col-md-5">
            		<div class="form-group">
            			...
            			<input class="form-control" type="text" name="kdoe" id="kode" maxlength="10" placeholder="Kode" readonly required />
            		</div>
            		<div class="form-group">
            ...
            <div id="tablesearchtampil">
            	<center>
            		...
            		<div class="popupsearch">
            			<div class="pre-scrollable">
            				<h3 align="center">Posisi Kendaraan</h3>
