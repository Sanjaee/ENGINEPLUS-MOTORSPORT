<?php
$projectmanager = $this->db->get('glbm_projectmanager')->result();
$statuskendaraan = $this->db->query('select * from glbm_statuskendaraan where aktif = true')->result();
$stkendaraan = $this->db->query('select * from glbm_statuspekerjaanmobil where aktif = true')->result();
?>

<div class="breadcrumb">
	<h1>Entry Dokumen WO</h1>
</div>
			...
			<div class="card-body">
				...
				<div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="nomor">Nomor WO</label>
								<div class="col-sm-9">
									<input class="form-control" type="text" name="nomor" id="nomor" maxlength="50" readonly srequired />
									<input class="form-control" type="hidden" name="nomorf" id="nomorf" maxlength="50" value="<?php echo !empty($nomor_wo) ? $nomor_wo : ""; ?>" readonly required />
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="booking">Booking</label>
								<br>
								<div class="col-sm-6 form-group">
									<label class="radio radio-success">
										<input type="radio" name="booking" id="booking" value="true"><span> YA</span><span class="checkmark"></span>
									</label>
									&emsp;&emsp;&emsp;
									<label class="radio radio-danger">
										<input type="radio" name="booking" id="nonbooking" value="false"><span> TIDAK</span><span class="checkmark"></span>
									</label>
								</div>
							</div>
						</div>
						<div class="col-md-6" id="book">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="nomorbooking">No Booking
									<span style="color: red; font-size: 10; font-weight: normal">*</span></label>
								<div class="col-sm-7">
									<input class="form-control" type="text" name="nomorbooking" id="nomorbooking" maxlength="50" readonly srequired />
								</div>
								<div class="col-sm-1.5 form-group">
									<button id="caribooking" class="btn-search btn-primary btn-block" data-toggle="modal" data-target="#findbooking">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="noestimasi">No Estimasi</label>
								<div class="col-sm-8 form-group">
									<input class="form-control" type="text" name="noestimasi" id="noestimasi" placeholder="Nomor Estimasi" maxlength="50" readonly required />
								</div>
								<div class="col-sm-1.5 form-group">
									<button id="cariestimasi" class="btn-search btn-primary btn-block" data-toggle="modal" data-target="#findestimasi">
										<i class="fa fa-search"></i>
									</button>
								</div>
							</div>
						...
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-4 form-group">
									<input class="form-control" type="text" name="nopolisi" id="nopolisi" placeholder="Nomor Polisi" maxlength="50" value="<?php echo !empty($nopol) ? urldecode($nopol) : ""; ?>" readonly required />
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="kode_foreman">Foreman
									<span style="color: red; font-size: 10; font-weight: normal">*</span></label>
								<div class="col-sm-2 form-group">
									<input class="form-control" type="text" name="kode_foreman" id="kode_foreman" placeholder="Kode" maxlength="150" readonly required />
								</div>
								<div class="col-sm-6 form-group">
									<input class="form-control" type="text" name="nama_foreman" id="nama_foreman" placeholder="Nama Foreman" maxlength="250" readonly required />
								</div>
								<div class="col-sm-1.5 form-group">
									<button id="cariforeman" class="btn-search btn-primary btn-block" data-toggle="modal" data-target="#findforeman">
										<i class="fa fa-search"></i>
									</button>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="kode_teknisi">Teknisi 1
									<span style="color: red; font-size: 10; font-weight: normal">*</span></label>
								<div class="col-sm-2 form-group">
									<input class="form-control" type="text" name="kode_teknisi" id="kode_teknisi" placeholder="Kode Teknisi 1" maxlength="150" readonly required />
								</div>
								<div class="col-sm-6 form-group">
									<input class="form-control" type="text" name="nama_teknisi" id="nama_teknisi" placeholder="Nama Teknisi 1" maxlength="250" readonly required />
								</div>
								<div class="col-sm-1.5 form-group">
									<button id="cariteknisi" class="btn-search btn-primary btn-block" data-toggle="modal" data-target="#findteknisi">
										<i class="fa fa-search"></i>
									</button>
								</div>
							</div>
						...
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="kode_teknisi">Teknisi 2</label>
								<!-- <span style="color: red; font-size: 10; font-weight: normal">*</span></label> -->
								<div class="col-sm-2 form-group">
									<input class="form-control" type="text" name="kode_teknisi2" id="kode_teknisi2" placeholder="Kode Teknisi 2" maxlength="150" readonly required />
								</div>
								<div class="col-sm-6 form-group">
									<input class="form-control" type="text" name="nama_teknisi2" id="nama_teknisi2" placeholder="Nama Teknisi 2" maxlength="250" readonly required />
								</div>
								<div class="col-sm-1.5 form-group">
									<button id="cariteknisi2" class="btn-search btn-primary btn-block" data-toggle="modal" data-target="#findteknisi2">
										<i class="fa fa-search"></i>
									</button>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="kode_teknisi">Teknisi 3</label>
								<!-- <span style="color: red; font-size: 10; font-weight: normal">*</span></label> -->
								<div class="col-sm-2 form-group">
									<input class="form-control" type="text" name="kode_teknisi3" id="kode_teknisi3" placeholder="Kode Teknisi 3" maxlength="150" readonly required />
								</div>
								<div class="col-sm-6 form-group">
									<input class="form-control" type="text" name="nama_teknisi3" id="nama_teknisi3" placeholder="Nama Teknisi 3" maxlength="250" readonly required />
								</div>
								<div class="col-sm-1.5 form-group">
									<button id="cariteknisi3" class="btn-search btn-primary btn-block" data-toggle="modal" data-target="#findteknisi3">
										<i class="fa fa-search"></i>
									</button>
								</div>
							</div>
						...
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="kode_teknisi">Teknisi 4 </label>
								<!-- <span style="color: red; font-size: 10; font-weight: normal">*</span> -->
								<div class="col-sm-2 form-group">
									<input class="form-control" type="text" name="kode_teknisi" id="kode_teknisi4" placeholder="Kode Teknisi 4" maxlength="150" readonly required />
								</div>
								<div class="col-sm-6 form-group">
									<input class="form-control" type="text" name="nama_teknisi" id="nama_teknisi4" placeholder="Nama Teknisi 4" maxlength="250" readonly required />
								</div>
								<div class="col-sm-1.5 form-group">
									<button id="cariteknisi4" class="btn-search btn-primary btn-block" data-toggle="modal" data-target="#findteknisi4">
										<i class="fa fa-search"></i>
									</button>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-5 form-group">
									<select name="jenis" class="form-control" id="jenis">
										...
										<option value="5">Turbo Kit dan Balap</option>
										<option value="6">Towing</option>
										<option value="7">Outsource KSS</option>
									</select>
								</div>
								<div class="col-sm-3 form-group">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="tanggalmasuk">Mobil Masuk
									<span style="color: red; font-size: 10; font-weight: normal">*</span></label>
								<div class="col-sm-3">
									<div class="input-group date" id="tglmasuk">
										<input type="text" class="form-control" id="tanggalmasuk" width="200" readonly>
								...
								<label class="col-sm-2 col-form-label" for="tglkerjakan">Tgl Mulai dikerjakan
									<span style="color: red; font-size: 10; font-weight: normal">*</span></label>
								<div class="col-sm-3">
									<div class="input-group date" id="tanggalkerja">
										<input type="text" class="form-control" id="tglkerjakan" width="200" readonly>
										<div class="input-group-prepend">
											<div class="input-group-text btn-primary">
												<span class="input-group-addon">
													<i class="fa fa-calendar"></i>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="tanggalestimasi">Estimasi Selesai
									<span style="color: red; font-size: 10; font-weight: normal">*</span></label>
								<div class="col-sm-5">
									<div class="input-group date" id="tanggalest">
										<input type="text" class="form-control" id="tanggalestimasi" width="200" readonly>
										<div class="input-group-prepend">
											<div class="input-group-text btn-primary">
												<span class="input-group-addon">
													<i class="fa fa-calendar"></i>
								...
								<div class="col-sm-4 form-group">
									<select name="statustunggu" class="form-control" id="statustunggu">
										<option value="0">- Pilih Status Tunggu -</option>
										<option value="1">Di tunggu</option>
										<option value="2">Di tinggal</option>
						...
						<!-- <div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="pic">Project Manager
									<span style="color: red; font-size: 10; font-weight: normal">*</span></label>
								<div class="col-sm-8 form-group">
									<input class="form-control" type="text" name="projectmanager" id="projectmanager" placeholder="Project Manager" maxlength="250" required />
								</div>
							</div>
						</div> -->
						...
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="projectmanager">Project Manager
									<span style="color: red; font-size: 10; font-weight: normal">*</span></label>
								<div class="col-sm-8 form-group">
									<select name="projectmanager" class="form-control" id="projectmanager">
										<option value="-">- Project Manager -</option>
										<?php foreach ($projectmanager as $pm) : ?>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="statuskendaraan">Posisi Kendaraan
									<span style="color: red; font-size: 10; font-weight: normal">*</span></label>
								<div class="col-sm-9 form-group">
									<select name="statuskendaraan" class="form-control" id="statuskendaraan">
										<option value="-">- Posisi Kendaraan -</option>
										<?php foreach ($statuskendaraan as $sk) : ?>
						...
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="stkendaraan">Status Kendaraan
									<span style="color: red; font-size: 10; font-weight: normal">*</span></label>
								<div class="col-sm-8 form-group">
									<select name="stkendaraan" class="form-control" id="stkendaraan">
										<option value="-">- Status Kendaraan -</option>
										<?php foreach ($stkendaraan as $pm) : ?>
											<option value="<?= $pm->nama ?>"><?= $pm->nama ?></option>
										<?php endforeach; ?>
									</select>
								</div>
										...
										<div class="col-md-9">
											<div class="form-group row">
												...
												<div class="col-sm-5 form-group">
													...
													<input class="form-control" type="hidden" name="kodestatus" id="kodestatus" placeholder="Detail Kategori" maxlength="150" style="text-align:left" required />
												</div>
											</div>
										</div>
									</div>
					...
					<!-- <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row" id="tableparts" require>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped display nowrap" id="detailparts">
                                            <tr>
                                                <th style="display:none;"></th>
                                                <th>Kode</th>
                                                <th>Nama</th>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row" id="tabletask" require>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped display nowrap" id="detailtask">
                                            <tr>
                                                <th style="display:none;"></th>
                                                <th>Kode</th>
                                                <th>Nama</th>
		...
		<div class="card mb-4">
			<div class="card-body">
				<div class="form-group">
					...
					<button id="cetakpkb" class="btn btn-success"><i class="fa fa-print"></i> &nbsp;CETAK PKB</button>
...
<!-- Find Data -->
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="findteknisi">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Data Teknisi</h5>
			...
			<div class="modal-body">
				<div class="table-responsive">
					<table id="tablesearchteknisi" class="table table-bordered table-striped display nowrap" style="width:100%">
						<thead>
							<tr>
								<th width="10"></th>
								<th width="25">Kode</th>
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="findteknisi2">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Data Teknisi 2</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<div class="table-responsive">
					<table id="tablesearchteknisi2" class="table table-bordered table-striped display nowrap" style="width:100%">
						<thead>
							<tr>
								<th width="10"></th>
								<th width="25">Kode</th>
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="findteknisi3">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Data Teknisi 3</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<div class="table-responsive">
					<table id="tablesearchteknisi3" class="table table-bordered table-striped display nowrap" style="width:100%">
						<thead>
							<tr>
								<th width="10"></th>
								<th width="25">Kode</th>
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="findteknisi4">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Data Teknisi 4</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<div class="table-responsive">
					<table id="tablesearchteknisi4" class="table table-bordered table-striped display nowrap" style="width:100%">
						<thead>
							<tr>
								<th width="10"></th>
								<th width="25">Kode</th>
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="findbooking">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<div class="table-responsive">
					<table id="tablesearchbk" class="table table-bordered table-striped display nowrap" style="width:100%">
						<thead>
							<tr>
								<th width="10"></th>
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="findforeman">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Data Foreman</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<div class="table-responsive">
					<table id="tablesearchforeman" class="table table-bordered table-striped display nowrap" style="width:100%">
						<thead>
							<tr>
								<th width="10"></th>
								<th width="25">Kode</th>
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="findestimasi">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Data Estimasi WO</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
