...
class Foreman extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model("masterdata/foreman_model");
    ...
    {
            $data = $this->foreman_model->getCabang($this->input->post('kode'));
    ...
    public function update()
    {
        ...
        $data = array(
            ...
            $result = $this->foreman_model->update($data,$this->input->post('kode'));
            if($result == true){
                $resultjson = array(
    ...
    {
            $data = $this->foreman_model->get($this->input->post('kode'));
            echo json_encode($data);
    }
    public function save()
    {
        $userlogin = $this->session->userdata('myusername');
        $get["mekanik"] = $this->foreman_model->get($this->input->post('kode')); 
		if (!$get["mekanik"]){
            $data = array(
                'kode' => $this->input->post('kode'),
                'nama' => $this->input->post('nama'),
            ...
            $result =  $this->foreman_model->save($data);
            if($result == true){
                $resultjson = array(
                    'kode' => $this->input->post('kode'),
